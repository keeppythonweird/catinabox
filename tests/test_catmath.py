...
def test__is_cat_leap_year__not_divisible_by_400__isnt_leap_year():
    assert catmath.is_cat_leap_year(1996) is True
...
def test__is_cat_leap_year__not_divisible_by_100__isnt_leap_year():
