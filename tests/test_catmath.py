...
def test__is_cat_leap_year__not_leap_year__fails():
    assert catmath.is_cat_leap_year(2015) is False


def test__is_cat_leap_year__not_divisible_by_400__fails():
    assert catmath.is_cat_leap_year(2100) is False


def test__is_cat_leap_year__divisible_by_100__fails():
