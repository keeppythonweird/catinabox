...
def test__is_cat_leap_year__leap_year_is_leap_year():
...
def test__is_cat_leap_year__divisible_by_100_isnt_leap_year():
    assert catmath.is_cat_leap_year(1900) is False


def test__is_cat_leap_year__century_leap_year__is_leap_year():
